...
-- '8', 'H', '50000', '1', '0'
select
    t3.CompanyName as DepartmentId,
    t2.Name as Employee,
    t2.Salary as Salary
from
    Employee t2
    inner join (
        SELECT
            t0.Salary as Salary,
            t0.DepartmentId as DepartmentId,
            count(*) as Rank,
        ...
        FROM
            (
                SELECT
                    distinct Salary,
                    DepartmentId,
                    Department.Name as CompanyName
                FROM
                    Employee
            ...
            left join (
                ...
                t0.DepartmentId = t1.DepartmentId
                and t0.Salary <= t1.Salary
            )
        group by
            t0.DepartmentId,
            t0.Salary
...
(count(*) <= 3)
        ...
        t2.DepartmentId = t3.DepartmentId
