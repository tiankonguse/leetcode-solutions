...
- [x] 1679. K 和数对的最大数目
- [x] 面试题 16.24. 数对和
- [x] 3623. 统计梯形的数目 I 1580
- [x] 3371. 识别数组中的最大异常值 1644
- [x] 624. 数组列表中的最大距离
- [x] 2364. 统计坏数对的数目 1622
- [x] 1014. 最佳观光组合 1730
- [x] 1814. 统计一个数组中好对子的数目 1738
- [x] 3584. 子序列首尾元素的最大乘积 1763
- [x] 2905. 找出满足差值条件的下标 II 1764 改成求个数要怎么做？
...
- [x] 2748. 美丽下标对的数目
- [x] 2506. 统计相似字符串对的数目
- [x] 2874. 有序三元组中的最大值 II 1583
- [x] 1031. 两个无重叠子数组的最大和 约 2000
- [x] 2555. 两个线段获得的最多奖品 2081
- [x] 1995. 统计特殊四元组 四个数
- [x] 3404. 统计特殊子序列的数目 2445 四个数
- [x] 3267. 统计近似相等数对 II 2545
- [x] 3480. 删除一个冲突对后最大子数组数目 2764
