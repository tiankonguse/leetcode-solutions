...
void init() {
  // 对于一道题有几个样例，手动填写
  problem_samples["club"] = 20;     // number
  problem_samples["employ"] = 25;   // polygon
  problem_samples["replace"] = 20;  // seat
  problem_samples["road"] = 25;     // xor
}
...
int main(int argc, char** argv) {
  ...
  string out_result_path = "/Users/tiankonguse-m3/project/github/data/2/results" + to_string(lastNum) + ".txt";
  string user_code_path = "/Users/tiankonguse-m3/project/github/data/2/answers";
  official_data_path = "/Users/tiankonguse-m3/project/github/data/CSP-S";
  ...
  map<string, tuple<int, int, int, int>> student_scores;
