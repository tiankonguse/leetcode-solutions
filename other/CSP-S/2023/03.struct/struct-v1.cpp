...
class Type {
 public:
  ...
  Type(const string& type_name_ = "", const ll type_size_ = 0, const bool base_type_ = false) : type_name(type_name_) {
  ...
  void EndMember() { this->type_size = (this->type_size + this->align_size - 1) / this->align_size * this->align_size; }
