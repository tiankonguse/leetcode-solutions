...
vector<int> buf;
inline int& Next(int id, int d) { return danceLinks[id].dir[d]; }
inline int End(int id) { return danceLinks[id].flag; }

vector<int> dirs = {DL, DD, RD};
inline void Remove(const int id) {
...
inline void Recover(const int id) {
