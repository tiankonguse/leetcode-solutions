...
Executing...
   ...
   Test 4: TEST OK [0.011 secs limit:1s, 1672 KB]
   Test 5: TEST OK [0.025 secs limit:1s, 1636 KB]
   Test 6: TEST OK [0.091 secs limit:1s, 1600 KB]
   Test 7: TEST OK [0.518 secs limit:1s, 1708 KB]
  > Run 8: Execution error: Your program (`checker') used more than
        the allotted runtime of 1 seconds (it ended or was stopped at
        1.855 seconds) when presented with test case 8. It used 1720 KB of
        memory. 

        ------ Data for Run 8 [length=3 bytes] ------
        13 
        ----------------------------
    Test 8: RUNTIME 1.855>1 (1720 KB)
*/