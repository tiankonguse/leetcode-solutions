...
submission: https://codeforces.com/edu/course/2/lesson/4/2/practice/contest/273278/submission/298551997
*/
#define TASK "C-first-element-at-least-X-bianry"
#define TASKEX ""
...
int Solver(const int x) {  //
  if (x > segTree.QueryMax(1, n)) {
    return -1;
  }
  int l = 1, r = n + 1;  // [l, r)
  while (l < r) {
