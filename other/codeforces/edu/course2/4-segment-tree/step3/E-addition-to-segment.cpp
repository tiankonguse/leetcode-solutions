/*
ID: tiankonguse
TASK: E. Addition to Segment  E. 添加到段
LANG: C++
MAC EOF: ctrl+D
link:
https://codeforces.com/edu/course/2/lesson/4/3/practice/contest/274545/problem/E
PATH: ITMO 学院：试点课程 » 线段树，第 1 部分 » 步骤3 » 实践
submission: https://codeforces.com/edu/course/2/lesson/4/3/practice/contest/274545/submission/298578890
*/
#define TASK "E-addition-to-segment"
#define TASKEX ""
...
void Solver() {  //
  ...
  while (m--) {
    ...
    if (op == 1) {
      int l, r, v;
      scanf("%d%d%d", &l, &r, &v);
      segTree.Update(l + 1, v);
      segTree.Update(r + 1, -v);
    } else {
      int r;
      scanf("%d", &r);
      printf("%lld\n", segTree.QuerySum(1, r + 1));
    }
  }
}
