/*
ID: tiankonguse
TASK: A. Inversions  A. 倒置
LANG: C++
MAC EOF: ctrl+D
link:
https://codeforces.com/edu/course/2/lesson/4/3/practice/contest/274545/problem/A
PATH: ITMO 学院：试点课程 » 线段树，第 1 部分 » 步骤3 » 实践
submission: https://codeforces.com/edu/course/2/lesson/4/3/practice/contest/274545/submission/298571097
*/
#define TASK "A-Inversions"
#define TASKEX ""
...
void Solver() {  //
  ...
  segTree.Build();
  for (int i = 1; i <= n; i++) {
    printf("%lld%c", segTree.QuerySum(nums[i - 1]+1, n+1), i == n ? '\n' : ' ');
    segTree.Update(nums[i - 1], 1);
  }
}
