...
int main(int argc, char** argv) {
  ...
  system("g++ ../A-Longest-palindromic-prefix-1-force.cpp -std=c++17 " BITS_STDC "  -o force.exe -O2");
  system("g++ ../A-Longest-palindromic-prefix-1.cpp -std=c++17 " BITS_STDC " -o main.exe -O2");
