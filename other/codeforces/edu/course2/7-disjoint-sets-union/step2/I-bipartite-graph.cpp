/*
ID: tiankonguse
TASK: I. Bipartite Graph  一、二分图
LANG: C++
MAC EOF: ctrl+D
link: https://codeforces.com/edu/course/2/lesson/7/2/practice/contest/289391/problem/I
...
int shift = 0;
inline int Shift(const int a) { return (a + shift) % n; }
